        ...
        <div className="xl:w-[54%] order-2 xl:order-none">
          <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl" action="">
            ...
            <p className="text-white/60">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed nihil quia, quisquam praesentium quaerat iusto possimus officia vitae commodi quod sint at rerum voluptatibus ratione alias! Excepturi doloribus praesentium amet?
            </p>
            {/* input */}
